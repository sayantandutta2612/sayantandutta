...
I’m **Sayantan**, a Data Engineer who enjoys building structured chaos out of raw data.  
I believe in writing **clean, scalable, automated, and resilient** data systems.

My approach is simple:

✔ Break complex problems into clean flows  
✔ Automate everything that looks repetitive  
✔ Learn every day — even from mistakes  
✔ Build with purpose, not just tools  

I love exploring Cloud, Data Engineering pipelines, workflow automation, and DevOps-ish tooling.  
If there’s an architecture diagram involved… I’m already interested. 😄
...
|--------|-------------|------|
| 🏛️ **Medallion Architecture Data Warehouse** | Designed a Bronze–Silver–Gold Lakehouse model using SQL-based ETL, focusing on clean data flow, modular transformations & scalability. | SQL • Lakehouse • ETL |
| 📊 **Data Analytics Project** | Analytical dashboards & insights built from structured datasets; focused on KPIs, trend analysis & business storytelling. | SQL • Python • Visualization |
...
### **Profile Views**
![](https://komarev.com/ghpvc/?username=SayantanDutta&label=Profile+Views&color=blueviolet&style=flat)
...
## ⭐ If you like my work…
**Drop a star ⭐** — it helps more than you think!  
And feel free to explore, fork, or contribute. Let’s build something amazing 🚀
